        ...
        <view class="xw-login-form">
            <form @submit="register" :rules="rules" ref="registerForm">
                <view class="xw-login-form-item">
                    <view class="xw-login-form-label">账{{"\u3000"}}号:</view>
                ...
                <view class="xw-login-form-item">
                    ...
                    <view class="code-box">
                        ...
                        <input class="xw-login-form-input" placeholder="随便输入4位字母" v-model="captcha" name="captcha"
                               type="text"/>
                ...
                <view class="xw-login-form-item">
                    <view class="xw-login-form-label">密{{"\u3000"}}码:</view>
                    <input class="xw-login-form-input" placeholder="输入你想设置的密码" name="password" :password="showPassword"
                           type="text" value=""/>
                    <view class="login-form-icon login-form-seepass" @click="changePassword">
                        <image :src="showPassword ? '../../static/images/l03.png' : '../../static/images/l04.png'"
                               mode="aspectFill"></image>
                    </view>
                </view>
                <view class="xw-login-form-item">
                    <view class="xw-login-form-label">昵{{"\u3000"}}称:</view>
                    <input class="xw-login-form-input" placeholder="快输入你的专属昵称吧" type="text" name="nickname" value=""/>
                </view>
